...
_C.LOSS.INST_LOSS_WEIGHT= 1.0
_C.LOSS.JOINT_LOSS_WEIGHT= 1.0
_C.LOSS.PIXEL_LOSS_WEIGHT= 1.0
...
_C.TRAIN.DIM_REDUCTION = True
_C.TRAIN.TEXT_CHANNELS = 512        #512
_C.TRAIN.INTER_CHANNELS = 256
